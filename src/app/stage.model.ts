...
export class multiquestionStage extends Stage {
    ...
    constructor (
        ...
        public questions: Array<Question> = [{type: "question", title: "First question goes here", choice: false, options: []},
        {type: "question", title: "Second question goes here", choice: false, options: []}],
